    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/dev/reset-admin-password").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/diet-plans/my/excel").hasRole("USER")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/weekly-meal-plans/my/excel").hasRole("USER")
